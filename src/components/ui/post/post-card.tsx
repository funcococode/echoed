...
export default function PostCard({post}: PostCardProps) {
  return (
    <div className="shadow-md shadow-gray-500/10 rounded p-10 flex gap-10 border border-gray-100">
      <div className="flex flex-col items-center justify-between text-gray-400 font-semibold">
          <p className="flex flex-col items-center gap-2 text-xs mt-1">{post.views}<TbEye /></p>
          <PostVotes post={post} />
      </div>
      <div className="flex flex-col divide-y gap-5 flex-1">
          ...
          <div className="flex items-center justify-between text-gray-500 text-xs pt-5">
              ...
              <div className="flex items-center gap-8">
                <p className="flex items-center gap-2"><TbMessage />{post._count?.comments ?? ''}</p>
