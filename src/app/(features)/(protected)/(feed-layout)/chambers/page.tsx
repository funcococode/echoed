    ...
    <section className="flex gap-4 ">
      <div className="space-y-4 flex-[3]">
        ...
        <div className="grid md:grid-cols-4 gap-4">
          {data?.map(item => <Link href={`/chambers/${item.id}`} className='group relative overflow-hidden hover:ring hover:ring-primary/20 hover:bg-primary/5 transition  rounded shadow shadow-gray-400/10 border' key={item.id}>
